...
class Scoreboard:
    ...
    def prep_score(self):
        #Thurn the score into a rendered image
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True, self.text_colour, self.settings.bg_color)
